@ta @ust @dms
 Feature: RR Creation:- Manually Create Billable RR
 	
 	 @ust @dms  
 	Scenario Outline: CreateRR_Manually :- Manually Create RR and check with proper required error message
...
#    	| ResourceNumber |Designation			 | Primary Skill								| Secondary Skill		 | Grade | 
#    	|  12			 |Applications Consultant| Business Analyst-Business Case Development   |Architect-DevOps-Digital| L2    | 
    	...
    	Then User click on All RR option.
   		...
   		Then User clicks on view supply button and search for a "095563" supply .
